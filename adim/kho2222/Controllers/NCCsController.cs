...
namespace kho2222.Controllers
{
    public class NCCsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "maNCC,tenNCC,dienthoai,diachi")] NCC nCC)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "maNCC,tenNCC,dienthoai,diachi")] NCC nCC)
        {
            if (ModelState.IsValid)
            {
