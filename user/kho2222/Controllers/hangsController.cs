    ...
    public class hangsController : Controller
    {
        ...
        public ActionResult Index(int? pape, string KeyWord, string filename = "", int asc = 1)
        {
            ...
            if (KeyWord != null && KeyWord != "")
            {
                ...
                questions = db.hangs.Where(m => m.maHG.Contains(KeyWord)).ToList();
            }
            else
            {
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "maHG,tenHG,namSX,hanSD,maLH,maNSX,tinhtrang,mota,thetich,gia,anh")] hang hang)
        {
        ...
        public ActionResult Edit([Bind(Include = "maHG,tenHG,namSX,hanSD,maLH,maNSX,tinhtrang,mota,thetich,gia,anh")] hang hang)
        {
            if (ModelState.IsValid)
            {
